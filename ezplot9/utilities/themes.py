    ...
    def __init__(self,
        ...
        self.add_theme(
            theme(figure_size = figure_size,
                  ...
                  plot_background = element_rect(fill='w', zorder=0),
                  panel_background = element_rect(fill='w', alpha=.2, zorder=1),
                  panel_grid_minor=element_line(size=0.2, alpha=1, color='0.9', zorder=2),
                  panel_grid_major=element_line(size=0.5, alpha=1, color='0.8', zorder=3),
                  panel_border=element_rect(color='k', size=0.51, zorder=4),
                  axis_line = element_line(color='k', size=0.51, zorder=5),
                  **kwargs),
            inplace=True)
